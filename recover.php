...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <fieldset><legend>Retrouvez votre compte</legend>
                  <p></p>
                  <form>
                    <table>
                      <tr><td><input type="email" class="form-control" name="email" placeholder="email...."/></td></tr>
                      <tr><td><input type="submit" class="btn btn-primary"  name="submit" value="Envoyer"/></td></tr>
                    </table>
                  </form>
                </fieldset>
