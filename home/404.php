...
<body>
    ...
    <div class="container">
      <center>
        ...
        <img width="400" src="404.gif" />
        <p> Le lien que vous avez suivi peut être incorrect ou la page peut avoir été supprimée. <a href="index.php">Retourner à la page d'acceuil</a></p>
      </center>
            </div>
